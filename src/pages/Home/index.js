  ...
  return (
    ...
    <ImageBackground
      ...
      <View style={{
        ...
        <MyList onPress={() => navigation.navigate('AAInput', user)} img={require('../../assets/A2.png')} judul="Skrining" desc="input skring nelayan IMT, TD, Lab Pemkab & kondisi kesehatan" />
